...
#Notification at your terminal if it has a agurment error
ERROR_DICT = {
...
This program is a Data Team Mini Project, which could work both automatically and manually.
...
Mandatory arguments to long options are mandatory for short options too.
    ...
    -h, --history=DATE          Download historical data. 
                                ...
                                e.g. 20230329 for 29 March 2023.
                                e.g. 20230401,20230529 for two days.
...
if __name__ == '__main__':
    try:
        ...
        opd = dict(opts)
        #This is the setup of linux command i use in this project 
        if '-a' in opd:
